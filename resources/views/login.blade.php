    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card w-25">
            <div class="card-header bg-primary d-flex justify-content-center">
                <strong>FROM <span class="text-light">LOGIN</span></strong>
            </div>
            <div class="card-body">
                ...
                <hr> 
                <span class="d-flex justify-content-center pb-4" style="color:#bebebe">Belum punya akun, segera daftar ya!</span>
